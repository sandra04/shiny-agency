...
export function formatFetchParams(answers) {
  // Récupère l'objet "answers"
  const answerNumbers = Object.keys(answers)

  // Itère sur chacune des réponses avec "reduce" qui passe sur les clés de l'objet
  // Concatène sur chaque réponse la string précédente avec la nouvelle string récupérée sur l'objet
        ...
        {resultsData &&
          resultsData.map((result, index) => (
            <JobTitle
              ...
              theme={theme}
            >
              {/* Avant la création de la fonction "formatJobList"
              {result.title}
